          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
				...
				<p class="text-center h3 fw-bold mb-5 mx-1 mx-md-4 mt-4"><?php if (isset($msg)) {
					echo $msg.'<br>';
					echo '<a href="login.php">Login now</a>';} ?></p>
                ...
                <form class="mx-1 mx-md-4" action="" method="POST">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="email" name="email" id="form3Example3c" class="form-control" placeholder="Email Address" required/>
                    </div>
                  </div>
